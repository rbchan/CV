...
\item King, DI, ME Akresh, DA Murillo, RE Bennett, and RB
...
\item Individual fitness, directional dispersal, and the dynamics of
  trailing-edge populations. 2023. PI with Drs. C. Rushing, J.
...
\begin{itemize}
  \item[] Animal Conservation, Annals of Applied Statistics, The Auk,
    ...
    Journal of Applied Ecology, Journal of Mammology, Methods in
    Ecology and Evolution, Nature Communications, Nature Ecology and
    Evolution, Ornotholog\'{i}a Neotropical, PLoS One, Spatial
    Statistics, Wildlife Society Bulletin.   
\end{itemize}
...
\begin{itemize}
   \item Elizabeth Warburton. Host-pathogen dynamics of chronic
     wasting disease and white-tailed deer.
   \item Will Lewis. Abundance and distribution of ruffed grouse in
     Georgia. 
